...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(IRSProperties IRSProperties) {
        this.cacheTimeToLive = DEFAULT_SECONDS_TO_LIVE;
        this.IRSProperties = IRSProperties;
    }

    public void init(FilterConfig filterConfig) throws ServletException {
        this.cacheTimeToLive = TimeUnit.DAYS.toMillis((long)this.IRSProperties.getHttp().getCache().getTimeToLiveInDays());
    }
