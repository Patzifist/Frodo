    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(io.github.frodo.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.repository.UserRepository.USERS_BY_LOGIN_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.repository.UserRepository.USERS_BY_EMAIL_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.domain.PersistentToken.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.frodo.application.domain.PersistentToken.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.frodo.application.domain.User.class.getName() + ".persistentTokens", new JCache<Object, Object>(
